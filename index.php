...
<section id="inicio" class="future-hero">
    ...
    <div class="container future-hero-grid">
        <div class="future-hero-copy">
            ...
            <p class="future-lead">Uma versão mais futurista, moderna e tecnológica do portal do cartório, unindo informação clara, navegação elegante e atendimento digital com identidade própria de Anísio de Abreu.</p>
        ...
        <aside class="future-showcase" aria-label="Identidade visual do portal">
            <div class="future-mascot-card">
                <div class="future-mascot-head">
                    <span class="mini-badge">Identidade local</span>
                    <strong>Tamanduá</strong>
                </div>
                <p>Mascote inspirado na cidade, incorporado ao site como símbolo de identidade, proximidade e singularidade visual.</p>
                <img src="assets/tamandua-mascot.svg" alt="Ilustração estilizada de um tamanduá, mascote do portal">
            </div>
...
<section class="future-mission-band">
    <div class="container future-mission-grid">
        <div>
            ...
            <p>O site combina elementos de interface moderna, camadas translúcidas, brilhos sutis e identidade visual local para criar uma apresentação mais marcante e atual.</p>
        </div>
        <div class="future-mini-panels">
            <article><strong>Mais futurista</strong><p>Visual com profundidade, glow e linguagem contemporânea.</p></article>
            ...
            <article><strong>Mais regional</strong><p>Presença do tamanduá como símbolo visual do portal.</p></article>
        </div>
    </div>
</section>
