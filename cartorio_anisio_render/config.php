...
return [
    'site_name' => env_value('SITE_NAME', 'Ofício Único de Anísio de Abreu - PI'),
    'short_name' => env_value('SITE_SHORT_NAME', 'Cartório de Anísio de Abreu'),
    'subtitle' => env_value('SITE_SUBTITLE', 'Serviços Notariais e de Registro'),
    'cns' => env_value('SITE_CNS', 'PREENCHER'),
    'responsible' => env_value('SITE_RESPONSIBLE', 'PREENCHER NOME DO RESPONSÁVEL'),
    'responsible_role' => env_value('SITE_RESPONSIBLE_ROLE', 'Tabelião/Oficial responsável'),
    'address' => env_value('SITE_ADDRESS', 'PREENCHER ENDEREÇO COMPLETO'),
    'city' => env_value('SITE_CITY', 'Anísio de Abreu - PI'),
    'phone' => env_value('SITE_PHONE', 'PREENCHER'),
    'whatsapp' => env_value('SITE_WHATSAPP', '55XXXXXXXXXXX'),
    'email' => env_value('SITE_EMAIL', 'PREENCHER@EMAIL.COM'),
    'hours' => env_value('SITE_HOURS', 'PREENCHER HORÁRIO DE ATENDIMENTO'),
